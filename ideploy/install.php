                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <?php
                            ...
                            $F->AddControls(array( 
                                array('type' => 'hidden', 'name' => 'install', 'value' => 'from_zip'),

                                array('type' => 'text', 'label' => 'Directory'),

                                array('type' => 'file', 'name' => 'file[]', 'label' => 'Zip Package'),
            ...
            <div class="panel-body">
                <?php
                    ...
                    $F->AddControls(array( 
                        ...
                        array('type' => 'text', 'label' => 'GIT Address'),
